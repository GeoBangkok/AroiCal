...
enum Config {
    ...
    // Superwall API configuration
    // Replace with your actual Superwall API key from https://superwall.com/dashboard
    static let superwallAPIKey: String = {
        // TODO: Replace with your actual Superwall API key
        // Get it from: https://superwall.com/dashboard -> Settings -> API Keys
        return "pk_t_HgxGd8wnJoGK0_BEFIR"  // Use the key from your screenshot
    }()
