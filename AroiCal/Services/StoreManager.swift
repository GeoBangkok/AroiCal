...
class StoreManager: ObservableObject {
    ...
    func purchase(productID: String) async {
        ...
        do {
            ...
            guard let product = try await fetchProduct(productID: productID) else {
    ...
    func fetchProducts() async throws -> [StoreKit.Product] {
        ...
        let products = try await StoreKit.Product.products(for: [monthlyProductID, annualProductID])
    ...
    private func fetchProduct(productID: String) async throws -> StoreKit.Product? {
        print("📦 Requesting product from App Store for: [\(productID)]")
